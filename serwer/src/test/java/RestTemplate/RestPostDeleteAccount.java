...
public class RestPostDeleteAccount {
    ...
    public static void main(String[] args) {
        ...
        // Adres URL endpointu
        String endpointUrl = "http://localhost:8081/deleteaccount";

        // Dane do wysłania w formacie JSON
        String jsonData = "{\"accountidtodelete\": \"2\"}"; // Identyfikator karty do usunięcia
