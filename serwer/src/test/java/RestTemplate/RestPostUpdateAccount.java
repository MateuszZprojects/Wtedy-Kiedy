...
public class RestPostUpdateAccount {
    ...
    public static void main(String[] args) {
        ...
        // Adres URL endpointu
        String endpointUrl = "http://localhost:8081/updateaccount";

        // Dane do wysłania w formacie JSON
        String jsonData = "{\"accountidtoupdate\": \"3\"}"; // Identyfikator karty do usunięcia
